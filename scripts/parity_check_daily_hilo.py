#!/usr/bin/env python3
"""scripts/parity_check_daily_hilo.py — Phase 12 Plan 02 (D-15 advisory).

Diffs an MQL5 buffer dump CSV against the Python compute_daily_hilo output.

Per CONTEXT D-15: Advisory only — non-blocking.

Usage:
    python scripts/parity_check_daily_hilo.py \\
        --csv ~/.mt5/.../MQL5/Files/parity_SM_Daily_HiLo_EURUSD_H1.csv \\
...
REPORT_PATH = EVIDENCE_DIR / "parity_daily_hilo_report.md"
...
def main() -> int:
    ...
    from v3_intelligence.sm_indicators.daily_hilo import (  # noqa: E402
        DailyHiLoParams,
        compute_daily_hilo,
    )

    py_out = compute_daily_hilo(py_in, DailyHiLoParams())
